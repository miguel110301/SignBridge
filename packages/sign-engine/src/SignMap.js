...
const LSM_METHOD_SOURCES = [
  'https://libreacceso.org/wp-content/uploads/2020/12/DIELSEME.pdf',
  'https://lsm.indiscapacidad.cdmx.gob.mx/',
]

const WIKISIGNS_LIST_SOURCE = 'https://www.wikisigns.org/list/es/lsm'

export const SIGN_LEXICON_WORDS = [
  {
    key: 'hola',
    word: 'hola',
    spoken: 'hola',
    ...
    baseModel: {
      handProfile: 'one_hand',
      bodyAnchor: 'head',
      motion: 'lateral_wave',
      requiresTraining: true,
      evidence: 'official_glossary',
    },
    sources: [
      'https://lsm.indiscapacidad.cdmx.gob.mx/ejes/saludos/',
      'https://www.wikisigns.org/es/lsm/hola',
      ...LSM_METHOD_SOURCES,
    ],
  },
  {
    ...
    baseModel: {
      handProfile: 'two_hands',
      bodyAnchor: 'neutral_space',
      motion: 'symmetric_global',
      minInterHandDistance: 0.18,
      requiresTraining: true,
      evidence: 'user_validated_plus_dictionary',
    },
    sources: [
      'https://www.wikisigns.org/es/lsm/Mundo',
      ...LSM_METHOD_SOURCES,
    ],
  },
  {
    ...
    baseModel: {
      handProfile: 'one_hand',
      bodyAnchor: 'face',
      motion: 'courtesy_release',
      requiresTraining: true,
      evidence: 'official_glossary_plus_dictionary',
    },
    sources: [
      'https://lsm.indiscapacidad.cdmx.gob.mx/ejes/saludos/',
      'https://www.wikisigns.org/es/lsm/gracias',
      ...LSM_METHOD_SOURCES,
    ],
  },
  {
    ...
    requiresTwoHands: false,
    baseModel: {
      handProfile: 'template_driven',
      bodyAnchor: 'upper_torso',
      motion: 'courtesy_template',
      requiresTraining: true,
      evidence: 'dictionary_pending_calibration',
    },
    sources: [WIKISIGNS_LIST_SOURCE, ...LSM_METHOD_SOURCES],
  },
  {
    key: 'si',
    word: 'si',
    ...
    baseModel: {
      handProfile: 'template_driven',
      bodyAnchor: 'neutral_space',
      motion: 'confirmation_template',
      requiresTraining: true,
      evidence: 'dictionary_pending_calibration',
    },
    sources: ['https://www.wikisigns.org/es/lsm/s%C3%AD', ...LSM_METHOD_SOURCES],
  },
  {
    key: 'no',
    word: 'no',
  ...
  },
  {
    ...
    baseModel: {
      handProfile: 'template_driven',
      bodyAnchor: 'face_or_mouth',
      motion: 'consumption_template',
      requiresTraining: true,
      evidence: 'community_dictionary',
    },
    sources: [WIKISIGNS_LIST_SOURCE, ...LSM_METHOD_SOURCES],
  },
  {
  ...
  },
  {
    ...
    baseModel: {
      handProfile: 'template_driven',
      bodyAnchor: 'body_region',
      motion: 'pain_template',
      requiresTraining: true,
      evidence: 'community_dictionary',
    },
    sources: ['https://www.wikisigns.org/es/lsm/dolor', ...LSM_METHOD_SOURCES],
  },
  {
    key: 'donde',
    word: 'donde',
...
export const DYNAMIC_GESTURE_MAP = [
  {
    gesture: 'lsm_j',
    summary: 'Letra J de LSM: trazo descendente y curvo con indice',
    type: 'dynamic_letter',
    implemented: false,
  },
  {
  ...
  {
    gesture: 'hola',
    summary: 'Dos dedos cerca de la cabeza con movimiento lateral tipo saludo',
    type: 'dynamic',
    requiredHandshape: 'two_fingers_near_head',
    requiredMotion: 'side_to_side_wave',
    notes: 'Usa rostro para ubicar la cabeza y worldLandmarks para estabilizar orientacion de la mano.',
    implemented: true,
    config: {
      windowMs: 1500,
      ...
      cooldownMs: 2200,
      minFrames: 10,
      minNearHeadRatio: 0.55,
      minTwoFingerRatio: 0.65,
      minPalmFacingRatio: 0.55,
      minRangeX: 0.075,
      minDirectionChanges: 1,
      minSwingAmplitude: 0.03,
      minSuppressRangeX: 0.035,
      minFacingScore: 0.38,
      maxFingerGap: 0.22,
      minFingerGap: 0.035,
      headZonePaddingX: 0.22,
      headZonePaddingTop: 0.2,
      headZonePaddingBottom: 0.08,
    },
  },
  ...SIGN_LEXICON_WORDS
    .filter((entry) => entry.key !== 'hola')
    .map((entry) => ({
      gesture: entry.key,
      summary: `Palabra del lexico demo: ${entry.spoken}`,
      type: 'dynamic_word',
      implemented: false,
      trainingOnly: true,
    })),
